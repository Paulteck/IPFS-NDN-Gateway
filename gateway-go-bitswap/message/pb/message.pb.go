...
type Message_Wantlist_Entry struct {
	...
	Coding       []byte                    `protobuf:"bytes,6,opt,name=coding,proto3" json:"coding,omitempty"`
...
func (m *Message_Wantlist_Entry) GetCoding() []byte {
	if m != nil {
		return m.Coding
	}
	return nil
...
func (m *Message_Wantlist_Entry) GetCount() int32 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *Message_Block) GetParent() []byte {
	if m != nil {
		return m.Parent
	}
	return nil
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (m *Message_Wantlist_Entry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Coding) > 0 {
		i -= len(m.Coding)
		copy(dAtA[i:], m.Coding)
		i = encodeVarintMessage(dAtA, i, uint64(len(m.Coding)))
		i--
		dAtA[i] = 0x32
	}
	if m.SendDontHave {
...
func (m *Message_Block) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Parent) > 0 {
		...
		i = encodeVarintMessage(dAtA, i, uint64(len(m.Parent)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Data) > 0 {
...
func (m *Message_Wantlist_Entry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Coding", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Coding = append(m.Coding[:0], dAtA[iNdEx:postIndex]...)
			if m.Coding == nil {
				m.Coding = []byte{}
			}
			iNdEx = postIndex
