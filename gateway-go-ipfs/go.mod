...
replace github.com/ipfs/go-bitswap => ../mars-go-bitswap
replace github.com/ipfs/go-block-format => ../mars-go-block-format
replace github.com/ipfs/go-ipld-format => ../mars-go-ipld-format
replace github.com/ipfs/go-unixfs => ../mars-go-unixfs
replace github.com/ipfs/go-merkledag => ../mars-go-merkledag
replace github.com/ipfs/interface-go-ipfs-core => ../mars-interface-go-ipfs-core
replace github.com/ipfs/go-blockservice => ../mars-go-blockservice
replace github.com/ipfs/go-ipfs-exchange-interface => ../mars-go-ipfs-exchange-interface
replace github.com/ipfs/go-ipfs-chunker => ../mars-go-ipfs-chunker

replace github.com/ipfs/go-peertaskqueue => ../mars-go-peertaskqueue
